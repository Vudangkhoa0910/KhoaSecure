      ...
      <div className="bg-white text-gray-800 p-8 rounded-lg shadow-lg w-full max-w-xl flex flex-col"> {/* Increased padding and max width */}
        {!isLoggedIn ? (
          ...
          <>
            ...
            <div
              className="border-4 border-dashed border-green-500 p-20 mb-4 rounded cursor-pointer w-full h-55 text-center bg-gray-200 hover:bg-gray-300" // Increased padding and added more styles
            ...
            >
              {file ? (
                ...
                <p className="text-lg">Drag & Drop your file here or click to select</p> // Larger text for more visibility
              )}
            </div>
